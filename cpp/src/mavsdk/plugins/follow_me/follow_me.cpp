...
MAVSDK_PUBLIC std::string_view to_string(FollowMe::Config::FollowAltitudeMode const& follow_altitude_mode)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::Config::FollowAltitudeMode const& follow_altitude_mode)
{
...
MAVSDK_PUBLIC bool operator==(const FollowMe::TargetLocation& lhs, const FollowMe::TargetLocation& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, FollowMe::TargetLocation const& target_location)
{
    str << std::setprecision(15);
    str << "target_location:" << '\n'
        << "{\n";
