...
MAVSDK_PUBLIC bool operator==(const Offboard::ActuatorControlGroup& lhs, const Offboard::ActuatorControlGroup& rhs)
{
    return
        (rhs.controls == lhs.controls);
}

MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::ActuatorControlGroup const& actuator_control_group)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Offboard::ActuatorControl& lhs, const Offboard::ActuatorControl& rhs)
{
    return
        (rhs.groups == lhs.groups);
}

MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::ActuatorControl const& actuator_control)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::AttitudeRate const& attitude_rate)
{
    str << std::setprecision(15);
    str << "attitude_rate:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const Offboard::PositionNedYaw& lhs, const Offboard::PositionNedYaw& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::PositionNedYaw const& position_ned_yaw)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::string_view to_string(Offboard::PositionGlobalYaw::AltitudeType const& altitude_type)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::PositionGlobalYaw::AltitudeType const& altitude_type)
{
    return str << to_string(altitude_type);
}
MAVSDK_PUBLIC bool operator==(const Offboard::PositionGlobalYaw& lhs, const Offboard::PositionGlobalYaw& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::PositionGlobalYaw const& position_global_yaw)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Offboard::VelocityBodyYawspeed& lhs, const Offboard::VelocityBodyYawspeed& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::VelocityBodyYawspeed const& velocity_body_yawspeed)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Offboard::VelocityNedYaw& lhs, const Offboard::VelocityNedYaw& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::VelocityNedYaw const& velocity_ned_yaw)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Offboard::AccelerationNed& lhs, const Offboard::AccelerationNed& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Offboard::AccelerationNed const& acceleration_ned)
{
    str << std::setprecision(15);
