...
MAVSDK_PUBLIC bool operator==(const ParamServer::FloatParam& lhs, const ParamServer::FloatParam& rhs)
{
    return
        (rhs.name == lhs.name) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::FloatParam const& float_param)
{
    str << std::setprecision(15);
    str << "float_param:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const ParamServer::CustomParam& lhs, const ParamServer::CustomParam& rhs)
{
    return
        (rhs.name == lhs.name) &&
        (rhs.value == lhs.value);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ParamServer::CustomParam const& custom_param)
{
    str << std::setprecision(15);
    str << "custom_param:" << '\n'
        << "{\n";
