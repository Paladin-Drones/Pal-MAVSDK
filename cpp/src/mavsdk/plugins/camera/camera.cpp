...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::SettingOptions const& setting_options)
{
    str << std::setprecision(15);
    str << "setting_options:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamSettings& lhs, const Camera::VideoStreamSettings& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamSettings const& video_stream_settings)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::string_view to_string(Camera::VideoStreamInfo::VideoStreamStatus const& video_stream_status)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo::VideoStreamStatus const& video_stream_status)
{
    return str << to_string(video_stream_status);
}

MAVSDK_PUBLIC std::string_view to_string(Camera::VideoStreamInfo::VideoStreamSpectrum const& video_stream_spectrum)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo::VideoStreamSpectrum const& video_stream_spectrum)
{
    return str << to_string(video_stream_spectrum);
}
MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamInfo& lhs, const Camera::VideoStreamInfo& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamInfo const& video_stream_info)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Camera::VideoStreamUpdate& lhs, const Camera::VideoStreamUpdate& rhs)
{
    return
        (rhs.component_id == lhs.component_id) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::VideoStreamUpdate const& video_stream_update)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Storage::StorageStatus const& storage_status)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::Storage::StorageType const& storage_type)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::StorageUpdate const& storage_update)
{
    str << std::setprecision(15);
    str << "storage_update:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const Camera::CurrentSettingsUpdate& lhs, const Camera::CurrentSettingsUpdate& rhs)
{
    return
        (rhs.component_id == lhs.component_id) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::CurrentSettingsUpdate const& current_settings_update)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const Camera::PossibleSettingOptionsUpdate& lhs, const Camera::PossibleSettingOptionsUpdate& rhs)
{
    return
        (rhs.component_id == lhs.component_id) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Camera::PossibleSettingOptionsUpdate const& possible_setting_options_update)
{
    str << std::setprecision(15);
