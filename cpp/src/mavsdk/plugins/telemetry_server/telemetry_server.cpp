...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Position& lhs, const TelemetryServer::Position& rhs)
{
    return
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Heading& lhs, const TelemetryServer::Heading& rhs)
{
    return
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Quaternion& lhs, const TelemetryServer::Quaternion& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Quaternion const& quaternion)
{
    str << std::setprecision(15);
    str << "quaternion:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::EulerAngle& lhs, const TelemetryServer::EulerAngle& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::EulerAngle const& euler_angle)
{
    str << std::setprecision(15);
    str << "euler_angle:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::AngularVelocityBody& lhs, const TelemetryServer::AngularVelocityBody& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityBody const& angular_velocity_body)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::GpsInfo& lhs, const TelemetryServer::GpsInfo& rhs)
{
    return
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::RawGps& lhs, const TelemetryServer::RawGps& rhs)
{
    return
        (rhs.timestamp_us == lhs.timestamp_us) &&
        ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) || rhs.latitude_deg == lhs.latitude_deg) &&
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Battery& lhs, const TelemetryServer::Battery& rhs)
{
    return
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::RcStatus& lhs, const TelemetryServer::RcStatus& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::RcStatus const& rc_status)
{
    str << std::setprecision(15);
    str << "rc_status:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::StatusText& lhs, const TelemetryServer::StatusText& rhs)
{
    return
        (rhs.type == lhs.type) &&
        (rhs.text == lhs.text);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusText const& status_text)
{
    str << std::setprecision(15);
    str << "status_text:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::ActuatorControlTarget& lhs, const TelemetryServer::ActuatorControlTarget& rhs)
{
    return
        (rhs.group == lhs.group) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorControlTarget const& actuator_control_target)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::ActuatorOutputStatus& lhs, const TelemetryServer::ActuatorOutputStatus& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ActuatorOutputStatus const& actuator_output_status)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Covariance& lhs, const TelemetryServer::Covariance& rhs)
{
    return
        (rhs.covariance_matrix == lhs.covariance_matrix);
}

MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Covariance const& covariance)
{
    str << std::setprecision(15);
    str << "covariance:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::VelocityBody& lhs, const TelemetryServer::VelocityBody& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityBody const& velocity_body)
{
    str << std::setprecision(15);
    str << "velocity_body:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionBody& lhs, const TelemetryServer::PositionBody& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionBody const& position_body)
{
    str << std::setprecision(15);
    str << "position_body:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::Odometry::MavFrame const& mav_frame)
{
    return str << to_string(mav_frame);
}
MAVSDK_PUBLIC bool operator==(const TelemetryServer::Odometry& lhs, const TelemetryServer::Odometry& rhs)
{
    return
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::DistanceSensor& lhs, const TelemetryServer::DistanceSensor& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::DistanceSensor const& distance_sensor)
{
    str << std::setprecision(15);
    str << "distance_sensor:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::ScaledPressure& lhs, const TelemetryServer::ScaledPressure& rhs)
{
    return
        (rhs.timestamp_us == lhs.timestamp_us) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::ScaledPressure const& scaled_pressure)
{
    str << std::setprecision(15);
    str << "scaled_pressure:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionNed& lhs, const TelemetryServer::PositionNed& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionNed const& position_ned)
{
    str << std::setprecision(15);
    str << "position_ned:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::VelocityNed& lhs, const TelemetryServer::VelocityNed& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VelocityNed const& velocity_ned)
{
    str << std::setprecision(15);
    str << "velocity_ned:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::PositionVelocityNed& lhs, const TelemetryServer::PositionVelocityNed& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::PositionVelocityNed const& position_velocity_ned)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::GroundTruth& lhs, const TelemetryServer::GroundTruth& rhs)
{
    return
        ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) || rhs.latitude_deg == lhs.latitude_deg) &&
        ((std::isnan(rhs.longitude_deg) && std::isnan(lhs.longitude_deg)) || rhs.longitude_deg == lhs.longitude_deg) &&
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::GroundTruth const& ground_truth)
{
    str << std::setprecision(15);
    str << "ground_truth:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::FixedwingMetrics& lhs, const TelemetryServer::FixedwingMetrics& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::FixedwingMetrics const& fixedwing_metrics)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::AccelerationFrd& lhs, const TelemetryServer::AccelerationFrd& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AccelerationFrd const& acceleration_frd)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::AngularVelocityFrd& lhs, const TelemetryServer::AngularVelocityFrd& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::AngularVelocityFrd const& angular_velocity_frd)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC bool operator==(const TelemetryServer::MagneticFieldFrd& lhs, const TelemetryServer::MagneticFieldFrd& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::MagneticFieldFrd const& magnetic_field_frd)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::VtolState const& vtol_state)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::StatusTextType const& status_text_type)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, TelemetryServer::LandedState const& landed_state)
{
