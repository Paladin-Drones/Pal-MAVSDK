...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Info::Identification const& identification)
{
    str << std::setprecision(15);
    str << "identification:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC std::string_view to_string(Info::Version::FlightSoftwareVersionType const& flight_software_version_type)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Info::Version::FlightSoftwareVersionType const& flight_software_version_type)
{
