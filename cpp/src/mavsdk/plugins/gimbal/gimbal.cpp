...
MAVSDK_PUBLIC bool operator==(const Gimbal::AngularVelocityBody& lhs, const Gimbal::AngularVelocityBody& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Gimbal::AngularVelocityBody const& angular_velocity_body)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Gimbal::ControlStatus const& control_status)
{
    str << std::setprecision(15);
    str << "control_status:" << '\n'
        << "{\n";
