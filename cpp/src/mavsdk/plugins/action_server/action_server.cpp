...
MAVSDK_PUBLIC bool operator==(const ActionServer::AllowableFlightModes& lhs, const ActionServer::AllowableFlightModes& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ActionServer::AllowableFlightModes const& allowable_flight_modes)
{
...
MAVSDK_PUBLIC bool operator==(const ActionServer::ArmDisarm& lhs, const ActionServer::ArmDisarm& rhs)
{
    return
        (rhs.arm == lhs.arm) &&
        (rhs.force == lhs.force);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ActionServer::FlightMode const& flight_mode)
{
