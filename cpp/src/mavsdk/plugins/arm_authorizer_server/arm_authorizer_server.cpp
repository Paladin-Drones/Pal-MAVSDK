...
MAVSDK_PUBLIC std::string_view to_string(ArmAuthorizerServer::RejectionReason const& rejection_reason)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, ArmAuthorizerServer::RejectionReason const& rejection_reason)
{
