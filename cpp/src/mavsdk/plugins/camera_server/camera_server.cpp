...
MAVSDK_PUBLIC bool operator==(const CameraServer::Information& lhs, const CameraServer::Information& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Information const& information)
{
...
MAVSDK_PUBLIC bool operator==(const CameraServer::VideoStreaming& lhs, const CameraServer::VideoStreaming& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::VideoStreaming const& video_streaming)
{
    str << std::setprecision(15);
    str << "video_streaming:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const CameraServer::Quaternion& lhs, const CameraServer::Quaternion& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::Quaternion const& quaternion)
{
    str << std::setprecision(15);
    str << "quaternion:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const CameraServer::CaptureInfo& lhs, const CameraServer::CaptureInfo& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureInfo const& capture_info)
{
    str << std::setprecision(15);
    str << "capture_info:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC std::string_view to_string(CameraServer::StorageInformation::StorageStatus const& storage_status)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageStatus const& storage_status)
{
    return str << to_string(storage_status);
}

MAVSDK_PUBLIC std::string_view to_string(CameraServer::StorageInformation::StorageType const& storage_type)
{
    switch (storage_type) {
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation::StorageType const& storage_type)
{
    return str << to_string(storage_type);
}
MAVSDK_PUBLIC bool operator==(const CameraServer::StorageInformation& lhs, const CameraServer::StorageInformation& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::StorageInformation const& storage_information)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::string_view to_string(CameraServer::CaptureStatus::ImageStatus const& image_status)
{
    switch (image_status) {
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::ImageStatus const& image_status)
{
    return str << to_string(image_status);
}

MAVSDK_PUBLIC std::string_view to_string(CameraServer::CaptureStatus::VideoStatus const& video_status)
{
    switch (video_status) {
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus::VideoStatus const& video_status)
{
    return str << to_string(video_status);
}
MAVSDK_PUBLIC bool operator==(const CameraServer::CaptureStatus& lhs, const CameraServer::CaptureStatus& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CaptureStatus const& capture_status)
{
    str << std::setprecision(15);
    str << "capture_status:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const CameraServer::TrackPoint& lhs, const CameraServer::TrackPoint& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::TrackPoint const& track_point)
{
    str << std::setprecision(15);
    str << "track_point:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const CameraServer::TrackRectangle& lhs, const CameraServer::TrackRectangle& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::TrackRectangle const& track_rectangle)
{
    str << std::setprecision(15);
    str << "track_rectangle:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, CameraServer::CameraFeedback const& camera_feedback)
{
