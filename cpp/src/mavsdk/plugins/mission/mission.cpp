...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionItem::CameraAction const& camera_action)
{
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionItem::VehicleAction const& vehicle_action)
{
...
MAVSDK_PUBLIC bool operator==(const Mission::MissionProgress& lhs, const Mission::MissionProgress& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::MissionProgress const& mission_progress)
{
    str << std::setprecision(15);
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::ProgressData const& progress_data)
{
    str << std::setprecision(15);
    str << "progress_data:" << '\n'
        << "{\n";
...
MAVSDK_PUBLIC bool operator==(const Mission::ProgressDataOrMission& lhs, const Mission::ProgressDataOrMission& rhs)
{
    return
...
MAVSDK_PUBLIC std::ostream& operator<<(std::ostream& str, Mission::ProgressDataOrMission const& progress_data_or_mission)
{
    str << std::setprecision(15);
